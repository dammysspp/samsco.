...
/* ==============================================
   DYNAMIC CUSTOM SMOOTH CURSOR
   ============================================== */
document.addEventListener("DOMContentLoaded", () => {
    const hasFinePointer = window.matchMedia("(pointer: fine)").matches;
    if (!hasFinePointer || typeof gsap === "undefined") {
        return;
    }
    ...
    const hoverSelectors = "a, button, [role='button'], .cursor-hover, .gallery-item, .wheel-card, .theme-dot, .mobile-link, .magnetic-btn";
    ...
    document.addEventListener("mouseover", (e) => {
        ...
        if (target) {
            ...
            cursorRing.classList.add("custom-cursor-blend");
            cursorDot.classList.add("custom-cursor-blend");
        }
    });
    ...
    document.addEventListener("mouseout", (e) => {
        ...
        if (target) {
            ...
            cursorRing.classList.remove("custom-cursor-blend");
            cursorDot.classList.remove("custom-cursor-blend");
        }
    });
